		...
		<div className="orders__main">
						...
						{currentOrder.dishes?.map((dish) => (
							<div className="order__items__main__container">
								...
								<div className="order__price">
									${(dish.price * dish.count).toFixed(2)}
								</div>
							</div>
						))}
					</div>
			...
			<div className="orders__container">
				...
				<div className="orders__categories">
					...
					<div
						className={`category__item ${
							["On the way", "Pick up Ready", "Preparing"].some(
								(el) => orderFilterSelected.includes(el)
							) && "selected__filter"
						}`}
						onClick={() =>
